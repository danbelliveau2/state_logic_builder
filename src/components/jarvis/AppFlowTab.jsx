...
const STAGES = [
  {
    ...
    rows: {
      ...
      loads: 'Standing knowledge, shipped-work precedents, station archetype notes, and your sheet’s device names ride into the call — by construction, every time. On a revision it also carries the current proposal so nothing you approved gets rebuilt from scratch.',
