...
export function ActionModal() {
  ...
  // Custom devices store operations in customTypeDef
  const operations = (selectedDevice?.type === 'Custom' && selectedDevice.customTypeDef?.operations?.length)
    ? selectedDevice.customTypeDef.operations
    : (typeInfo?.operations ?? []);
  ...
  function handleDeviceChange(id) {
    ...
    const ops = (dev?.type === 'Custom' && dev.customTypeDef?.operations?.length)
      ? dev.customTypeDef.operations
      : (DEVICE_TYPES[dev?.type]?.operations ?? []);
